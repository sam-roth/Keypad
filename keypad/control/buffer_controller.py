...
def _selection_code_completion_hint(s):
    ...
    :rtype: keypad.buffers.selection.Selection
    '''
    return s
...
class BufferController(Tagged, Responder):
    def __init__(self, buffer_set, view, buff, provide_interaction_mode=True, config=None):
        '''
        :type view: keypad.abstract.textview.AbstractTextView
...
def set_specific_config(target, key, value):
    from keypad.util import dotted_pairs_to_dict
...
from keypad.abstract.code import Diagnostic, AbstractCallTip
