...
from keypad.core.attributed_string import RangeDict
from keypad.util.coordmap import TextCoordMapper, LinearInterpolator
...
#         line_spacing = Qt.QFontMetricsF(self._settings.q_font).lineSpacing()
    ...
    def get_line_pixmap(self, *, plane_pos, line, width, 
        ...
        Use a :py:class:`keypad.util.coordmap.LinearInterpolator` to find the
