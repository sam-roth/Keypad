...
import re
from keypad.api import interactive, autoconnect, BufferController
from keypad.control.interactive import run as run_interactive
...
class RegexSearcher(object):
    ...
    >>> from keypad.plugins.search import *
